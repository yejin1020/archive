 ...
 */
package cse.my_name.ood_ch08.control;
...
public class DownloadServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String selectedFile = request.getParameter("file_name");
        String targetDirectory = request.getParameter("dirName");
        //selectedFile = URLEncoder.encode(selectedFile,"UTF-8");
        //String absolutpath = targetDirectory+selectedFile;
        try {
            System.out.println("======-====");
