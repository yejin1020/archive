 ...
 * @author yejin
 */
@WebServlet(urlPatterns = {"/ch09/logging.do"})
public class LoggingServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            prop.setProperty("org.apach.commoms.logging.Log","org.apach.commons.logging.impl.SimpleLog");
            prop.setProperty("org.apache.commons.logging.simplelog.defaultlog", "info");
            prop.setProperty("org.apache.commons.logging.simplelog.showingname", "true");
